...
os.system("""mysql -u {usr} {dba} -e "CREATE TABLE flights (flightyear SMALLINT, flightmonth SMALLINT, dayofmonth SMALLINT, dayofweek SMALLINT, flightdate DATE, carrierID VARCHAR(10), flightnumber MEDIUMINT, originairport MEDIUMINT, origincityMID MEDIUMINT, origin VARCHAR(10), origincitystate VARCHAR(255), originstate VARCHAR(10), destairport MEDIUMINT, destcityMID MEDIUMINT, destination VARCHAR(10), destcitystate VARCHAR(255), deststate VARCHAR(10), deptime MEDIUMINT, depdelay FLOAT, depdelay15bool TINYINT, arrtime MEDIUMINT,arrdelay FLOAT, arrdelay15bool TINYINT, cancelledbool TINYINT, cancelcode VARCHAR(255), distance FLOAT, carrierdelay FLOAT, weatherdelay FLOAT, nasdelay FLOAT, securitydelay FLOAT, lateaircraftdelay FLOAT);" """.format(**sqlsettings))
